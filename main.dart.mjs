...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1616: x0 => x0.preventDefault(),
      _1617: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1617(f,arguments.length,x0) }),
      _1618: x0 => x0.type,
      _1619: x0 => x0.callback,
      _1629: x0 => x0.getAsFile(),
      _1630: x0 => x0.webkitGetAsEntry(),
      _1631: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1631(f,arguments.length,x0) }),
      _1632: (x0,x1) => x0.getAsString(x1),
      _1633: x0 => x0.slice(),
      _1634: x0 => x0.arrayBuffer(),
      _1648: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1649: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1668: (x0,x1) => x0.getItem(x1),
      _1675: (x0,x1) => x0.querySelector(x1),
      _1676: (x0,x1) => x0.createElement(x1),
      _1677: (x0,x1) => x0.querySelector(x1),
      _1678: (x0,x1) => x0.item(x1),
      _1681: () => new FileReader(),
      _1682: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1687: (x0,x1) => x0.removeChild(x1),
      _1688: x0 => x0.click(),
      _1689: (x0,x1) => x0.removeChild(x1),
      _1703: x0 => new Array(x0),
      _1705: x0 => x0.length,
      _1707: (x0,x1) => x0[x1],
      _1708: (x0,x1,x2) => x0[x1] = x2,
      _1711: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1713: x0 => new Int8Array(x0),
      _1714: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1715: x0 => new Uint8Array(x0),
      _1721: x0 => new Uint16Array(x0),
      _1723: x0 => new Int32Array(x0),
      _1725: x0 => new Uint32Array(x0),
      _1727: x0 => new Float32Array(x0),
      _1729: x0 => new Float64Array(x0),
      ...
      _1740: (o, a) => o + a,
      _1761: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1762: () => new TextDecoder("utf-8", {fatal: true}),
      _1763: () => new TextDecoder("utf-8", {fatal: false}),
      _1764: x0 => new WeakRef(x0),
      _1765: x0 => x0.deref(),
      _1771: Date.now,
      _1773: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1774: s => {
      ...
      _1776: () => typeof dartUseDateNowForTicks !== "undefined",
      _1777: () => 1000 * performance.now(),
      _1778: () => Date.now(),
      _1780: () => {
      ...
      _1781: () => new WeakMap(),
      _1782: (map, o) => map.get(o),
      _1783: (map, o, v) => map.set(o, v),
      _1784: () => globalThis.WeakRef,
      _1795: s => JSON.stringify(s),
      _1796: s => printToConsole(s),
      _1797: a => a.join(''),
      _1798: (o, a, b) => o.replace(a, b),
      _1800: (s, t) => s.split(t),
      _1801: s => s.toLowerCase(),
      _1802: s => s.toUpperCase(),
      _1803: s => s.trim(),
      _1804: s => s.trimLeft(),
      _1805: s => s.trimRight(),
      _1807: (s, p, i) => s.indexOf(p, i),
      _1808: (s, p, i) => s.lastIndexOf(p, i),
      _1809: (s) => s.replace(/\$/g, "$$$$"),
      _1810: Object.is,
      _1811: s => s.toUpperCase(),
      _1812: s => s.toLowerCase(),
      _1813: (a, i) => a.push(i),
      _1817: a => a.pop(),
      _1818: (a, i) => a.splice(i, 1),
      _1820: (a, s) => a.join(s),
      _1821: (a, s, e) => a.slice(s, e),
      _1824: a => a.length,
      _1826: (a, i) => a[i],
      _1827: (a, i, v) => a[i] = v,
      _1829: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1830: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1831: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1832: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1833: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1834: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1835: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      ...
      _1839: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1840: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1841: (t, s) => t.set(s),
      _1842: l => new DataView(new ArrayBuffer(l)),
      _1843: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1845: o => o.buffer,
      _1846: o => o.byteOffset,
      _1847: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1848: (b, o) => new DataView(b, o),
      _1849: (b, o, l) => new DataView(b, o, l),
      _1850: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1851: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1852: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1853: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1854: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1855: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1856: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1857: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1858: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1859: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1860: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1861: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1864: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1865: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1866: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1867: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1868: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1869: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _2230: (x0,x1) => x0.draggable = x1,
      _2246: x0 => x0.style,
      _3178: (x0,x1) => x0.accept = x1,
      _3192: x0 => x0.files,
      _3218: (x0,x1) => x0.multiple = x1,
      _3236: (x0,x1) => x0.type = x1,
      _3957: (x0,x1) => x0.dropEffect = x1,
      _3958: x0 => x0.effectAllowed,
      _3960: x0 => x0.items,
      _3961: x0 => x0.types,
      _3963: (x0,x1) => x0[x1],
      _3967: x0 => x0.length,
